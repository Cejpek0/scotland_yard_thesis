...
import ray
from environments.scotland_yard_pettingzoo import ScotlandYardPettingzoo, ScotlandYardPettingzoo_RAW
...
register_env("ScotlandYard", lambda config: ScotlandYardPettingzoo_RAW(env_creator(config)))


def run_same_policy(args, stop):
    """Use the same policy for both agents (trivial case)."""
    config = PPOConfig().environment("ScotlandYard").framework(args.framework)
