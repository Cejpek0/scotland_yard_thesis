...
A to proto, že právě hry mají jasná pravidla, jejich výkon je snadno měřitelný a pokrok dokáže vidět i lajk.
...
Tato práce zkoumá algoritmy posilovaného učení, jejich použití na hry s neurčitostí a porovnání s klasickýmy metodami hraní her.
...
Použité algoritmy pro vytvoření této umělé inteligence bohužel nejsou zveřejněny.

Změnu opět přinesla společnost OpenAI a jejich projekt \emph{OpenAI Five}\cite{Dota2}.
...
U OpenAI Five je akční prostor rozdělen na hlavní akce a parametry.
...
Tyto akce mají 3 parametry, zpoždění, vybranou jednotku a cíl akce.
Pokud tyto akce a jejich parametry zkombinujeme získáme akční prostor o velikosti 1,837,080 dimenzí.
Výsledný reakční čas agenta je okolo 33ms.
Reakční čas profesionálních herních hráčů je okolo 100ms\cite{reaction_time}

Na začátku byla většina chování agentů uměle skriptována a postupně jim byla předávána kontrola nad vlastním chováním s využití politiky.
...
Ta definuje, které akce jsou v momentálním stavu prostředí validní.
...
Uvažujme však 3D hru kde se agent může hýbat za pomocí aplikování silového vektoru o různých velikostech.
