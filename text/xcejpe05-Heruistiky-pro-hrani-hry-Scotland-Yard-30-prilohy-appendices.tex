...
\begin{itemize}
    ...
    \item \texttt{trained\char`_models\char`_dqn/} -- Složka s~natrénovaným modelem DQN.
    \item \texttt{trained\char`_models\char`_ppo/} -- Složka s~natrénovaným modelem PPO
    ...
    \item \texttt{main.py} -- Soubor, jehož spuštěním se spustí grafické rozhraní hry Scotland Yard.
