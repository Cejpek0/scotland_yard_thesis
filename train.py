...
from environments.scotland_yard_environment_1v1 import ScotlandYardEnvironment1v1
from ray.rllib.algorithms.ppo import PPOConfig

from pettingzoo.test import api_test
from environments.scotland_yard_pettingzoo import ScotlandYardPettingzoo
from environments.test import env as test_envv
...
def train_action_mask(steps=10_000, seed=0, **env_kwargs):
...
if __name__ == "__main__":
    ...
    train_action_mask(steps=20_480, seed=0)

    # Evaluate 100 games against a random agent (winrate should be ~80%)
    eval_action_mask(num_games=100, render_mode=None)

    # Watch two games vs a random agent
    eval_action_mask(num_games=2, render_mode="human")
